    ...
    return (
        <div className=' w-full h-max md:h-screen xl:h-screen flex bg-creator bg-cover flex-col bg-fixed'>
            <div className='w-full h-max backdrop-blur-sm pt-10'>
                ...
                <div className='w-full h-12 bg-gradient-to-t from-[#070f74] to-transparent' data-aos='fade-up' data-aos-duration="1000"></div>
                <div className='w-full h-max bg-[#070f74] flex justify-center items-center' data-aos='fade-up' data-aos-duration="1000">
                    <div className='w-full h-max md:h-max md:pb-10 md:grid md:grid-cols-2 md:grid-rows-2 md:gap-5 px-5 bg-[#070f74] xl:w-1/2'>
                        <a href='https://www.instagram.com/thepalakgupta/' data-aos='zoom-out-up'>
                            <div className=' w-auto h-max rounded-xl shadow-xl p-10 flex justify-center items-center flex-col md:mt-5' id='parent'>
                                <img src={require('../assets/creators/palki.jpeg')} className='rounded-[50%] aspect-square w-1/2 opacity-80' alt='' />
                                <p className='text-[#c1c7ff] mt-10 text-3xl font-bold'>Palak Gupta</p>
                            </div>
                        </a>
                        ...
                        <a href='https://www.instagram.com/this_is_hiten/' data-aos='zoom-out-up'>
                        ...
                        <a href='https://www.instagram.com/_paritosh.jha_/' data-aos='zoom-out-up'>
                            <div className=' w-auto h-max rounded-xl shadow-xl p-10 flex justify-center items-center flex-col mt-5 md:mt-0' id='parent'>
