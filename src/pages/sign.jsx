    ...
    return (
        <div className="w-full h-screen bg-back flex justify-center items-center flex-col">
            ...
            <div className='w-[400px] h-max py-3 flex justify-between items-center'>
                <button className='text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-700 w-1/2 border-4 font-bold mr-1 border-purple-600 py-3 rounded-md'>Sign in</button>
                <button className='lg:flex font-semibold text-white w-1/2 py-4 justify-center bg-slate-600 rounded-md bg-gradient-to-r ml-1 from-[#9625b8] to-[#d307b1]' >Sign In</button>
            </div>
