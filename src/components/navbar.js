...
const NavBar = () => {
    ...
    return (
        <>
            <nav className='w-full h-20 bg-transparent flex lg:px-6 backdrop-blur-sm justify-between px-3 md:px-5 xl:px-[12.5rem] 2xl:px-[15rem] top-0 absolute z-40'>
                <div className='lg:w-2/3 sm:w-max flex items-center sm:h-full' id='LeftPart'>
                    ...
                    <ul className=' hidden text-white lg:flex flex-row mx-2.5'>
                        ...
                        <li className='mx-2.5 text-md'>Recent</li>
            ...
            <div className=' z-50 translate-x-full transition duration-200 ease-in-out w-full h-screen absolute top-0 right-0 backdrop-blur-3xl bg-slate-800 bg-opacity-20 p-12 flex justify-center items-center flex-col lg:hidden' id="SlidingNav">
                ...
                <ul className='text-white text-center'>
                    <li className='m-5 text-md'>Home</li>
                    <li className='m-5 text-md'>Trending</li>
                    <li className='m-5 text-md'>Recent</li>
                    <li className='m-5 text-md'>Explore</li>
                </ul>
