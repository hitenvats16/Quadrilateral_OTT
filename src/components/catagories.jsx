    ...
    return (
        <div className='w-full h-max flex justify-center items-center flex-col xl:px-80' id='frame'>
            ...
            <div className='w-max h-ful grid grid-cols-1 grid-rows-6 gap-2 mb-5 md:grid-cols-2 md:grid-rows-3 xl:grid-cols-3 xl:grid-rows-2' id="grid">
                ...
                <Link to='/explore' data-aos='fade-up'>
                    <div className="w-80 h-32 bg-cover bg-comedy rounded-md xl:w-96 xl:hover:scale-y-110 xl:hover:duration-300 xl:hover:ease-in-out ">
                        <div className=' bg-opacity-30 bg-black w-full h-full flex'>
                ...
                <Link to='/explore' data-aos='fade-up'>
                    <div className="w-80 h-32 bg-cover bg-drama rounded-md xl:w-96 xl:hover:scale-y-110 xl:hover:duration-300 xl:hover:ease-in-out">
                        <div className=' bg-opacity-30 bg-black w-full h-full flex'>
                ...
                <Link to='/explore' data-aos='fade-up'>
                    <div className="w-80 h-32 bg-cover bg-horror rounded-md xl:w-96 xl:hover:scale-y-110 xl:hover:duration-300 xl:hover:ease-in-out">
                        <div className=' bg-opacity-30 bg-black w-full h-full flex'>
                ...
                <Link to='/explore' data-aos='fade-up'>
                    <div className="w-80 h-32 bg-cover bg-romantic rounded-md xl:w-96 xl:hover:scale-y-110 xl:hover:duration-300 xl:hover:ease-in-out">
                        <div className=' bg-opacity-30 bg-black w-full h-full flex'>
                ...
                <Link to='/explore' data-aos='fade-up'>
                    <div className="w-80 h-32 bg-cover bg-scifi rounded-md xl:w-96 xl:hover:scale-y-110 xl:hover:duration-300 xl:hover:ease-in-out">
                        <div className=' bg-opacity-30 bg-black w-full h-full flex'>
