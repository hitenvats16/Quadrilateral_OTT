...
const SlidingCards = () => {
    return (
        <Swiper navigation={true} modules={[Navigation]} className=' w-full h-[500px] md:h-[600px]'>
            <SwiperSlide className='w-full h-full bg-pic2 object-cover bg-cover'>
            ...
            <SwiperSlide className='w-full h-full bg-pic1 object-cover bg-cover'>
                <div className='absolute bottom-0 left-0 my-4 mx-6 md:mx-10 md:my-6 xl:px-[200px] xl:w-[1200px]'>
            ...
            <SwiperSlide className='w-full h-full bg-pic3 object-cover bg-cover'>
                <div className='absolute bottom-0 left-0 my-4 mx-6 md:mx-10 md:my-6 xl:px-[200px] xl:w-[1200px]'>
